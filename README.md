This plugin uses the Random method of Java to generate a number below one that is set in the config.yml file. For negatives, it subtracts the generated numbers from 0. It then checks 
